...
% (MANDATORY)
files       = {sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/%s/%s/mrs/motorcortex/mega-press/%s_%s_mega-press.dat', sub, ses, sub, ses)};
...
% default.
files_ref   = {sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/%s/%s/mrs/motorcortex/mega-press_ref/%s_%s_mega-press_ref.dat', sub, ses, sub, ses)};
% files_ref = {};
% Specify water data for quantification (e.g. short-TE water scan)
% (OPTIONAL)
files_w     = {sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/%s/%s/mrs/motorcortex/water/%s_%s_water.dat', sub, ses, sub, ses)};
% files_w = {};                 
...
files_nii   = {sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/%s/%s/anat/%s_%s_T1w.nii.gz', sub, ses, sub, ses)};
...
% (MANDATORY)
outputFolder = sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/derivatives/MRS/preprocessed/%s/%s/%s_%s_MC', sub, ses, sub, ses);
