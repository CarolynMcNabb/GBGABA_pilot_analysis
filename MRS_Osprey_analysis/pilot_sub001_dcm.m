...
% (MANDATORY)
files       = {'/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/sub-001/ses-01/mrs/dicoms/mega-press'};
...
% default.
files_ref   = {'/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/sub-001/ses-01/mrs/dicoms/mega-press_ref'};
% files_ref = {};
% Specify water data for quantification (e.g. short-TE water scan)
% (OPTIONAL)
% files_w     = {'/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/sub-001/ses-01/mrs/dicoms/water'};
files_w = {};                 
