...
data_folder = '/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS'; 
...
for kk = 1:length(subs)
    ...
    for ll = 1:length(sess)
        ...
        % (OPTIONAL)
        dir_w    = dir([sess(ll).folder filesep sess(ll).name filesep 'mrs' filesep 'motorcortex' filesep 
        'water' filesep '*.SDAT']);
...
file_stat = fullfile('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/derivatives/MRS/analysis/GLMs/GLM_faecalLCMS.csv');
...
% (MANDATORY)
outputFolder = '/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/derivatives/MRS/analysis/group_analysis'
