...
% (MANDATORY)
files       = {sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/%s/%s/mrs/occipital/mega-press/%s_%s_mega-press.dat', sub, ses, sub, ses)};
...
% default.
files_ref   = {sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/%s/%s/mrs/occipital/mega-press_ref/%s_%s_mega-press_ref.dat', sub, ses, sub, ses)};
% files_ref = {};
% Specify water data for quantification (e.g. short-TE water scan)
% (OPTIONAL)
files_w     = {sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/%s/%s/mrs/occipital/water/%s_%s_water.dat', sub, ses, sub, ses)};
% files_w = {};                 
...
% (MANDATORY)
outputFolder = sprintf('/Volumes/gold/cinn/2020/gbgaba/pilot_BIDS/derivatives/MRS/preprocessed/%s/%s/%s_%s_OCC', sub, ses, sub, ses);
